...
fmacloud.query_tpl_works=function(a,d,b,f,c,h,i,g){var e=fmacloud.Object.extend("tplobj");e=new fmacloud.Query(e);e.equalTo("tpl_type",a);e.skip(c);e.limit(h);a=false;if(b!=null)f?e.ascending(b):e.descending(b);switch(d){case "all":break;case "onsale":e.greaterThan("approved",0);break;case "not onsale":e.equalTo("approved",0);break;case "editor rec":e.greaterThan("approved",0);e.greaterThan("editor_recno",0);e.ascending("editor_recno");break;case "author rec":e.greaterThan("approved",0);e.greaterThan("author_recno",
0);e.ascending("author_recno");break;default:d=d.split(":");if(d.length>1)switch(d[0]){case "label":d.splice(0,1);e.containsAll("label",d);break;default:a=true;break}}a?g(fmacloud.Error(fmacloud.Error.REQUEST_NOT_SUPPORTED,"")):e.find({success:i,error:g})};
fmacloud.query_res=function(a,d,b,f,c,h,i,g){a=fmacloud.Object.extend(a);a=new fmacloud.Query(a);a.skip(c);a.limit(h);c=false;if(b!=null)f?a.ascending(b):a.descending(b);switch(d){case "all":break;default:b=d.split(":");if(b.length>1)switch(b[0]){case "label":b.splice(0,1);a.containsAll("label",b);break;case "type":d=parseInt(b[1]);a.equalTo("category",d);break;case "type_and_scale":d=parseInt(b[1]);b=unescape(b[2]);a.equalTo("category",d);a.equalTo("scale",b);break;default:c=true;break}}c?g(fmacloud.Error(fmacloud.Error.REQUEST_NOT_SUPPORTED,
"")):a.find({success:i,error:g})};fmacloud.query_corpus=function(a,d,b,f,c,h,i,g){a=fmacloud.Object.extend(a);a=new fmacloud.Query(a);a.skip(c);a.limit(h);c=false;if(b!=null)f?a.ascending(b):a.descending(b);switch(d){case "all":break;case "category":break;default:d=d.split(":");if(d.length>1)switch(d[0]){case "label":d.splice(0,1);a.containsAll("label",d);break;default:c=true;break}}c?g(fmacloud.Error(fmacloud.Error.REQUEST_NOT_SUPPORTED,"")):a.find({success:i,error:g})};
fmacloud.execute_array_task=function(a,d,b,f,c){b(a[d],function(){d<a.length-1?fmacloud.execute_array_task(a,d+1,b,f,c):f(a)},c)};fmacloud.execute_array_task_async=function(a,d,b,f,c,h){fmacloud.init_queue_task();var i=fmacloud.Object.prototype,g=fmaobj.params.create();g.set("arg1",a);g.set("arg2",d);g.set("arg3",b);g.set("arg4",f);g.set("arg5",c);g.set("arg6",h);i.task_queue.push(g);if(h==null)h=0;setTimeout("_fmacloud_execute_queue()",h)};
function _fmacloud_execute_queue(){var a=fmacloud.Object.prototype,d=a.task_queue;if(d.length>0){var b=d.shift(),f=b.get("arg1"),c=b.get("arg2");d=b.get("arg3");var h=b.get("arg4"),i=b.get("arg5"),g=b.get("arg6");d(f[c],function(){if(c<f.length-1){b.set("arg2",c+1);a.task_queue.push(b);if(g==null)g=0;setTimeout("_fmacloud_execute_queue()",g)}else h(f)},i)}}fmacloud.init_queue_task=function(){var a=fmacloud.Object.prototype;a.task_queue=[]};
fmacloud._fetch_object=function(a,d,b,f){fmacloud.execute_array_task(a,d,function(c,h,i){c.fetch().then(h,i)},function(c){b(c)},f)};
fmacloud.get_tpl_works_data=function(a,d,b){var f=fmacloud.Object.extend("pages_data");f=new fmacloud.Query(f);f.equalTo("key_id",a);f.find().then(function(c){if(c.length>0){var h=c[0];c=h.get("pages");fmacloud._fetch_object(c,0,function(i){fmacloud.execute_array_task(i,0,function(g,e,j){g=g.get("item_object");fmacloud._fetch_object(g,0,e,j)},function(){var g=h.get("pages")[0];g.get("item_object")[0].get("item_id")!=null?d(h):b(new fmacloud.Error(3201,"\u5143\u7d20\u6570\u636e\u53ef\u80fd\u5df2\u53d7\u5230\u635f\u574f\u3002"))},
b)},b)}else b(new fmacloud.Error(3202,"\u6307\u5b9aID\u7684\u6570\u636e\u4e0d\u5b58\u5728\u3002"))},function(c){b(c)})};
fmacloud.erase_tpl_works=function(a,d,b,f){try{var c=fmacloud.Object.extend("pages_data"),h=new fmacloud.Query(c);d.destroy({success:function(g){b(g)},error:function(g,e){alert("\u5220\u9664\u5bf9\u8c61\u5931\u8d25\uff1a"+g.get("objectid")+"\u539f\u56e0\u662f\uff1a"+e);f(g,e)}});h.equalTo("key_id",a);h.find({success:function(g){for(var e=0;e<g.length;e++){for(var j=g[0],l=j.get("pages"),r=0;r<l.length;r++){var u=l[r];u.fetch({success:function(o){for(var p=o.get("item_object"),s=0;s<p.length;s++){var v=
p[s];v.fetch({success:function(m){var k=null;if(m.get("item_cntype")==2)k=fmacapi_filename_fromurl(m.get("item_val"));else if(m.get("item_cntype")==3)k=m.get("item_val");if(k!=null){k=j.get("key_id")+"."+k;var q=fmacloud.Object.extend("_File");q=new fmacloud.Query(q);q.equalTo("name",k);q.find({success:function(n){if(n.length>0){var t=new fmacloud.File;t.id=n[0].id;t.destroy().then(function(){},function(w){alert("\u6587\u4ef6\u5220\u9664\u5931\u8d25\uff1a"+w.message)})}},error:function(n){alert("\u67e5\u627e\u6587\u4ef6\u5bf9\u8c61\u5931\u8d25: "+
n.code+" "+n.message)}})}m.destroy()},error:function(){alert("elem\u5b50\u5bf9\u8c61fetch\u5931\u8d25\uff0c\u539f\u56e0\uff1a"+error.code+" "+error.message)}})}o.destroy()},error:function(){alert("page\u5b50\u5bf9\u8c61fetch\u5931\u8d25\uff0c\u539f\u56e0\uff1a"+error.code+" "+error.message)}})}j.destroy({success:function(){},error:function(o,p){alert("\u5220\u9664\u6570\u636e\u5931\u8d25\uff1a"+o.get("objectid")+"\u539f\u56e0\u662f\uff1a"+p)}})}},error:function(g){alert("\u67e5\u627e\u6570\u636e\u5931\u8d25\uff1a"+
g.message)}})}catch(i){fmacapi_report_exception(i)}};function fma_getMSec(){var a=new Date;return a.getMilliseconds()}fmacloud.tpl_save_effect_img=function(a,d,b,f){if(d!=null&&d!=""){var c=a.get("effect_img");if(c.substr(0,3)=="AV:")c=c.slice(3);var h=new fmacloud.File(c+".png",{base64:d});h.save().then(function(){a.set("effect_img","AV:"+h.url());var i=Math.round(640/3),g=Math.round(a.get("tpl_height")*i/a.get("tpl_width"));i=h.thumbnailURL(i,g);a.set("tiny_img","AV:"+i);b(a)},f)}else b(a)};
fmacloud.tpl_save_all=function(a,d,b,f,c){try{if(a.get("tpl_width")<=0||a.get("tpl_height")<=0)c(new fmacloud.Error(3202,"\u6a21\u7248\u6570\u636e\u4e0d\u6b63\u786e\uff08\u5bbd\u6216\u9ad8\u5c0f\u4e8e\u7b49\u4e8e\u96f6\uff09\u3002"));else b==null?d.save().then(function(){a.save().then(function(){f(a)},c)},c):fmacloud.tpl_save_effect_img(a,b.effect_img,function(){b.elem_imgs==null||b.elem_imgs.length==0?d.save().then(function(){a.save().then(function(){f(a)},c)},c):fmacloud.execute_array_task_async(b.elem_imgs,
0,function(i,g){var e;e=d.get("pages")[i[0]];e=e.get("item_object");var j=e[i[1]];if(j.get("item_cntype")==2){e=j.get("item_val");var l=e.lastIndexOf("/");e=e.substr(l+1,e.length-l-1)}else if(j.get("item_cntype")==3){e=j.get("item_val");if(e.substr(0,3)=="AV:")e=e.slice(3)}else e=fmacapi_create_uid();file=new fmacloud.File(e+".png",{base64:i[2]});file.save().then(function(){j.set("item_cntype",2);j.set("item_val",file.url());g(i)},c)},function(){d.save().then(function(){a.save().then(function(){f(a)},
c)},c)},c,1200)},function(i){c(i)})}catch(h){c(h)}};fmacloud.request_img_base64=function(a,d,b){a=a.substr(a.indexOf("/filestore"));a=fms_api_url+"?mod=fms_img&act=tobase64&file="+a;$.ajax({type:"GET",url:a,dataType:"json",success:function(f){f=f;f.status?d(f.data):b(f.error)},error:function(f,c,h){b(c||h.message)}})};
fmacloud.copy_remote_resource=function(a,d,b){var f=a.get("arg1"),c=a.get("arg2");a=a.get("arg3");var h="";if(f.get("item_cntype")==2){h=f.get("item_val");var i=h.lastIndexOf("/");h=h.substr(i+1)}else if(f.get("item_cntype")==3)h=f.get("item_val");else return false;h=c.lastIndexOf("/");var g=c.substr(h+1);filename=a+"."+g;c=c.substr(c.indexOf("/filestore"));c=fms_api_url+"?mod=fms_img&act=tobase64&file="+c;$.ajax({type:"GET",url:c,dataType:"json",success:function(e){e=$.parseJSON(e);if(e.status){var j=
new fmacloud.File(g+".png",{base64:e.data});j.save().then(function(){f.set("item_cntype",2);f.set("item_val",j.url());d(f)},b)}}});return true};
